...
Slim Bootloader support uefipayload
===================================

      repo : https://github.com/Advgcipc/edk2.git
    commit : 89709f519eecfc2d79d9492c3f796266cd6b02e1
...
-----------------
  ...
  Usage:
    ...
    python Sbl.py -p 'ahclsbl','edk','advgcipc','sbl' -c $(Porject ID)
